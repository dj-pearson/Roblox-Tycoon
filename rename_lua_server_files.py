...
if __name__ == "__main__":
    server_directory = r"c:\Users\pears\OneDrive\Documents\Roblox Scripts\src\server"
    if os.path.exists(server_directory):
        print(f"Starting to rename Lua files in {server_directory}")
        rename_lua_files(server_directory)
    else:
        print(f"Directory not found: {server_directory}")